        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('employee.form') }}" :active="request()->routeIs('employee.form')">
                        {{ __('Evaluation form') }}
                    </x-nav-link><x-nav-link href="{{ route('employee.resources') }}" :active="request()->routeIs('employee.resources')">
                        {{ __('Resources') }}
                    </x-nav-link><x-nav-link href="{{ route('employee.journal') }}" :active="request()->routeIs('employee.journal')">
                        {{ __('Journaling') }}
                    </x-nav-link>
